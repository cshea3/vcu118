...
#
# Generated by Vivado on Mon Dec 05 17:06:02 EST 2022
...
#
#    "/home/cwshea/git/vcu118/hw/myproj/project_1.srcs/constrs_1/new/microblaze_spi.xdc"
#    "/home/cwshea/git/vcu118/hw/myproj/project_1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/myproj/project_1.srcs/constrs_1/new/microblaze_spi.xdc"]"\
 "[file normalize "$origin_dir/myproj/project_1.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set file "[file normalize "$origin_dir/myproj/project_1.srcs/constrs_1/new/microblaze_spi.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/microblaze_spi.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/microblaze_spi.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/microblaze_spi.xdc]" -objects $obj
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  # Create ports
  set fmc_chipselect [ create_bd_port -dir O -from 4 -to 0 fmc_chipselect ]
  set fmc_sclk [ create_bd_port -dir O fmc_sclk ]
  set fmc_sdi [ create_bd_port -dir I -type data fmc_sdi ]
  set fmc_sdo [ create_bd_port -dir O fmc_sdo ]
  ...
  # Create port connections
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_ports fmc_sdo] [get_bd_pins axi_quad_spi_0/io0_o]
  ...
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_ports fmc_sclk] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports fmc_chipselect] [get_bd_pins axi_quad_spi_0/ss_o]
  ...
  connect_bd_net -net fmc_sdi_1 [get_bd_ports fmc_sdi] [get_bd_pins axi_quad_spi_0/io0_i]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_0_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_100M/peripheral_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.544094",
   "Default View_TopLeft":"1518,873",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port led_8bits -pg 1 -lvl 8 -x 2510 -y 790 -defaultsOSRD
preplace port rs232_uart -pg 1 -lvl 8 -x 2510 -y 450 -defaultsOSRD
preplace port sysclk_125 -pg 1 -lvl 0 -x 0 -y 780 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x 0 -y 800 -defaultsOSRD
preplace port port-id_fmc_sdi -pg 1 -lvl 0 -x 0 -y 1090 -defaultsOSRD
preplace port port-id_fmc_sdo -pg 1 -lvl 8 -x 2510 -y 990 -defaultsOSRD
preplace port port-id_fmc_sclk -pg 1 -lvl 8 -x 2510 -y 1240 -defaultsOSRD
preplace portBus fmc_chipselect -pg 1 -lvl 8 -x 2510 -y 1350 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 6 -x 2040 -y 280 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 6 -x 2040 -y 1760 -defaultsOSRD
preplace inst axi_timer_0 -pg 1 -lvl 6 -x 2040 -y 110 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 6 -x 2040 -y 460 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 7 -x 2350 -y 280 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 140 -y 790 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 3 -x 850 -y 800 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -x 1250 -y 610 -defaultsOSRD
preplace inst microblaze_0_axi_intc -pg 1 -lvl 3 -x 850 -y 590 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -x 1670 -y 240 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 5 -x 1670 -y 620 -defaultsOSRD
preplace inst microblaze_0_xlconcat -pg 1 -lvl 2 -x 480 -y 360 -defaultsOSRD
preplace inst rst_clk_wiz_0_100M -pg 1 -lvl 2 -x 480 -y 740 -defaultsOSRD
preplace inst axi_quad_spi_0 -pg 1 -lvl 6 -x 2040 -y 1130 -defaultsOSRD
preplace netloc axi_timer_0_interrupt 1 1 6 260 -20 NJ -20 NJ -20 NJ -20 NJ -20 2220
preplace netloc axi_uartlite_0_interrupt 1 1 6 270 470 690J 460 NJ 460 NJ 460 1830J 540 2220
preplace netloc blk_mem_gen_0_rsta_busy 1 1 7 270 -10 NJ -10 NJ -10 NJ -10 NJ -10 NJ -10 2490
preplace netloc blk_mem_gen_0_rstb_busy 1 1 7 290 0 NJ 0 NJ 0 NJ 0 NJ 0 NJ 0 2480
preplace netloc clk_wiz_0_locked 1 1 1 290 780n
preplace netloc mdm_1_debug_sys_rst 1 1 3 290 480 NJ 480 980
preplace netloc microblaze_0_Clk 1 1 5 260 630 710 700 1010 700 1500 20 1860
preplace netloc microblaze_0_intr 1 2 1 700 360n
preplace netloc reset_1 1 0 2 20 710 270J
preplace netloc rst_clk_wiz_0_100M_bus_struct_reset 1 2 3 660J 730 NJ 730 1510
preplace netloc rst_clk_wiz_0_100M_mb_reset 1 2 2 700 710 1000
preplace netloc rst_clk_wiz_0_100M_peripheral_aresetn 1 2 4 680 400 NJ 400 1510 10 1870
preplace netloc axi_quad_spi_0_ip2intc_irpt 1 1 6 290 460 670J 450 1010J 520 NJ 520 1820J 550 2190
preplace netloc clk_wiz_0_clk_out2 1 1 5 280 640 670J 720 NJ 720 NJ 720 1830J
preplace netloc fmc_sdi_1 1 0 7 NJ 1090 NJ 1090 NJ 1090 NJ 1090 NJ 1090 1820J 1320 2180
preplace netloc axi_quad_spi_0_io0_o 1 6 2 2220 990 NJ
preplace netloc axi_quad_spi_0_sck_o 1 6 2 2220 1240 NJ
preplace netloc axi_quad_spi_0_ss_o 1 6 2 2200 1350 NJ
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 6 1 N 270
preplace netloc axi_bram_ctrl_0_BRAM_PORTB 1 6 1 N 290
preplace netloc axi_gpio_0_GPIO 1 6 2 2210J 790 NJ
preplace netloc axi_uartlite_0_UART 1 6 2 NJ 450 NJ
preplace netloc microblaze_0_axi_dp 1 4 1 1490 80n
preplace netloc microblaze_0_axi_periph_M01_AXI 1 5 1 1900 210n
preplace netloc microblaze_0_axi_periph_M02_AXI 1 5 1 1840 230n
preplace netloc microblaze_0_axi_periph_M03_AXI 1 5 1 1890 250n
preplace netloc microblaze_0_axi_periph_M04_AXI 1 5 1 1880 60n
preplace netloc microblaze_0_debug 1 3 1 990 600n
preplace netloc microblaze_0_dlmb_1 1 4 1 N 590
preplace netloc microblaze_0_ilmb_1 1 4 1 N 610
preplace netloc microblaze_0_intc_axi 1 2 4 710 470 NJ 470 NJ 470 1820
preplace netloc microblaze_0_interrupt 1 3 1 1010 580n
preplace netloc sysclk_125_1 1 0 1 NJ 780
preplace netloc microblaze_0_axi_periph_M05_AXI 1 5 1 1850 290n
levelinfo -pg 1 0 140 480 850 1250 1670 2040 2350 2510
pagesize -pg 1 -db -bbox -sgen -130 -170 2700 1840
"
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvu9p-flga2104-2L-e -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvu9p-flga2104-2L-e -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
